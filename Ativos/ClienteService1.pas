...
// WSDL     : http://10.10.100.34:8680/rico-webservice/ClienteService?wsdl
//  >Import : http://10.10.100.34:8680/rico-webservice/ClienteService?wsdl>0
// Encoding : UTF-8
// Codegen  : [wfForceSOAP12+]
// Version  : 1.0
// (17/12/2020 09:37:46 - - $Rev: 96726 $)
// ************************************************************************ //
...
type
  ...
  pesquisarClienteResponse2 = class;            { "http://service.commons.rico.ativos.com.br/"[GblCplx] }
  pesquisarClienteResponse = class;             { "http://service.commons.rico.ativos.com.br/"[GblElm] }
  atualizarCliente2    = class;                 { "http://service.commons.rico.ativos.com.br/"[GblCplx] }
  atualizarCliente     = class;                 { "http://service.commons.rico.ativos.com.br/"[GblElm] }
  atualizarClienteResponse2 = class;            { "http://service.commons.rico.ativos.com.br/"[GblCplx] }
  atualizarClienteResponse = class;             { "http://service.commons.rico.ativos.com.br/"[GblElm] }
  pesquisarCliente2    = class;                 { "http://service.commons.rico.ativos.com.br/"[GblCplx] }
  pesquisarCliente     = class;                 { "http://service.commons.rico.ativos.com.br/"[GblElm] }
  escritorio           = class;                 { "http://service.commons.rico.ativos.com.br/"[GblCplx] }
  pesquisarLstCliente2 = class;                 { "http://service.commons.rico.ativos.com.br/"[GblCplx] }
  pesquisarLstCliente  = class;                 { "http://service.commons.rico.ativos.com.br/"[GblElm] }
  listarClientesRetomados2 = class;             { "http://service.commons.rico.ativos.com.br/"[GblCplx] }
  listarClientesRetomados = class;              { "http://service.commons.rico.ativos.com.br/"[GblElm] }
  ...
  // ************************************************************************ //
  // XML       : pesquisarClienteResponse, global, <complexType>
  // Namespace : http://service.commons.rico.ativos.com.br/
  // ************************************************************************ //
  pesquisarClienteResponse2 = class(TRemotable)
  private
    Freturn: cliente;
    Freturn_Specified: boolean;
    procedure Setreturn(Index: Integer; const Acliente: cliente);
    function  return_Specified(Index: Integer): boolean;
  public
    destructor Destroy; override;
  published
    property return: cliente  Index (IS_OPTN) read Freturn write Setreturn stored return_Specified;
  end;



  // ************************************************************************ //
  // XML       : pesquisarClienteResponse, global, <element>
  // Namespace : http://service.commons.rico.ativos.com.br/
  // ************************************************************************ //
  pesquisarClienteResponse = class(pesquisarClienteResponse2)
  private
  published
  end;

  listarClientesRetomadosResponse2 = array of cliente;   { "http://service.commons.rico.ativos.com.br/"[GblCplx] }
  listarClientesRetomadosResponse = listarClientesRetomadosResponse2;      { "http://service.commons.rico.ativos.com.br/"[GblElm] }


  // ************************************************************************ //
  // XML       : atualizarCliente, global, <complexType>
  // Namespace : http://service.commons.rico.ativos.com.br/
  // ************************************************************************ //
  atualizarCliente2 = class(TRemotable)
  private
    Fcliente: cliente;
  ...
  public
    destructor Destroy; override;
  published
    property cliente: cliente  Index (IS_OPTN) read Fcliente write Setcliente stored cliente_Specified;
  end;



  // ************************************************************************ //
  // XML       : atualizarCliente, global, <element>
  // Namespace : http://service.commons.rico.ativos.com.br/
  // ************************************************************************ //
  atualizarCliente = class(atualizarCliente2)
  private
  published
  end;
  ...
  pesquisarLstClienteResponse2 = array of cliente;   { "http://service.commons.rico.ativos.com.br/"[GblCplx] }
  pesquisarLstClienteResponse = pesquisarLstClienteResponse2;      { "http://service.commons.rico.ativos.com.br/"[GblElm] }


  // ************************************************************************ //
  // XML       : atualizarClienteResponse, global, <complexType>
  // Namespace : http://service.commons.rico.ativos.com.br/
  // ************************************************************************ //
  atualizarClienteResponse2 = class(TRemotable)
  private
    Freturn: string;
    Freturn_Specified: boolean;
  ...
  // ************************************************************************ //
  // XML       : atualizarClienteResponse, global, <element>
  // Namespace : http://service.commons.rico.ativos.com.br/
  // ************************************************************************ //
  atualizarClienteResponse = class(atualizarClienteResponse2)
  private
  published
  end;
  ...
  // ************************************************************************ //
  // XML       : pesquisarCliente, global, <complexType>
  // Namespace : http://service.commons.rico.ativos.com.br/
  // ************************************************************************ //
  pesquisarCliente2 = class(TRemotable)
  private
    Fndg: string;
  ...
  published
    property ndg:     string  Index (IS_OPTN) read Fndg write Setndg stored ndg_Specified;
  ...
  // ************************************************************************ //
  // XML       : pesquisarCliente, global, <element>
  // Namespace : http://service.commons.rico.ativos.com.br/
  // ************************************************************************ //
  pesquisarCliente = class(pesquisarCliente2)
  private
  published
  end;
  ...
  published
    ...
    property nomeAbreviado: string  Index (IS_OPTN) read FnomeAbreviado write SetnomeAbreviado stored nomeAbreviado_Specified;
  ...
  // ************************************************************************ //
  // XML       : pesquisarLstCliente, global, <complexType>
  // Namespace : http://service.commons.rico.ativos.com.br/
  // ************************************************************************ //
  pesquisarLstCliente2 = class(TRemotable)
  private
    Fndg: string;
    Fndg_Specified: boolean;
    FcpfCnpj: string;
  ...
  // ************************************************************************ //
  // XML       : pesquisarLstCliente, global, <element>
  // Namespace : http://service.commons.rico.ativos.com.br/
  // ************************************************************************ //
  pesquisarLstCliente = class(pesquisarLstCliente2)
  private
  published
  end;
  ...
  // ************************************************************************ //
  // XML       : listarClientesRetomados, global, <complexType>
  // Namespace : http://service.commons.rico.ativos.com.br/
  // ************************************************************************ //
  listarClientesRetomados2 = class(TRemotable)
  private
    FdataRetomada: TXSDateTime;
    FdataRetomada_Specified: boolean;
    procedure SetdataRetomada(Index: Integer; const ATXSDateTime: TXSDateTime);
    function  dataRetomada_Specified(Index: Integer): boolean;
  public
    destructor Destroy; override;
  published
    property dataRetomada: TXSDateTime  Index (IS_OPTN) read FdataRetomada write SetdataRetomada stored dataRetomada_Specified;
  end;



  // ************************************************************************ //
  // XML       : listarClientesRetomados, global, <element>
  // Namespace : http://service.commons.rico.ativos.com.br/
  // ************************************************************************ //
  listarClientesRetomados = class(listarClientesRetomados2)
  private
  published
  end;
  ...
  published
    property sigla:     string  Index (IS_OPTN) read Fsigla write Setsigla stored sigla_Specified;
  ...
  published
    ...
    property tipoTelefone:   tipoTelefone    read FtipoTelefone write FtipoTelefone;
    property statusTelefone: statusTelefone  read FstatusTelefone write FstatusTelefone;
    property cliente:        cliente         Index (IS_OPTN) read Fcliente write Setcliente stored cliente_Specified;
  end;
  ...
  public
    destructor Destroy; override;
  published
    property idOperacao:              Integer      Index (IS_OPTN) read FidOperacao write SetidOperacao stored idOperacao_Specified;
    property contrato:                string       Index (IS_OPTN) read Fcontrato write Setcontrato stored contrato_Specified;
    property lote:                    Integer      Index (IS_OPTN) read Flote write Setlote stored lote_Specified;
    property qtdeNegociacao:          Integer      Index (IS_OPTN) read FqtdeNegociacao write SetqtdeNegociacao stored qtdeNegociacao_Specified;
    property produto:                 produto      Index (IS_OPTN) read Fproduto write Setproduto stored produto_Specified;
    property modalidade:              modalidade   Index (IS_OPTN) read Fmodalidade write Setmodalidade stored modalidade_Specified;
    property statusAcordo:            string       Index (IS_OPTN) read FstatusAcordo write SetstatusAcordo stored statusAcordo_Specified;
    property statusOperacao:          string       Index (IS_OPTN) read FstatusOperacao write SetstatusOperacao stored statusOperacao_Specified;
    property valorPresente:           Double       Index (IS_OPTN) read FvalorPresente write SetvalorPresente stored valorPresente_Specified;
    property valorPresenteFinanceiro: Double       Index (IS_OPTN) read FvalorPresenteFinanceiro write SetvalorPresenteFinanceiro stored valorPresenteFinanceiro_Specified;
    property valorAtualizado:         Double       Index (IS_OPTN) read FvalorAtualizado write SetvalorAtualizado stored valorAtualizado_Specified;
    property ultimoValorNegociado:    Double       Index (IS_OPTN) read FultimoValorNegociado write SetultimoValorNegociado stored ultimoValorNegociado_Specified;
    property dataVencimento:          TXSDateTime  Index (IS_OPTN) read FdataVencimento write SetdataVencimento stored dataVencimento_Specified;
    property valorLiquidacao:         Double       Index (IS_OPTN) read FvalorLiquidacao write SetvalorLiquidacao stored valorLiquidacao_Specified;
    property valorSaldoAquisicao:     Double       Index (IS_OPTN) read FvalorSaldoAquisicao write SetvalorSaldoAquisicao stored valorSaldoAquisicao_Specified;
    property valorSaldoPerdas:        Double       Index (IS_OPTN) read FvalorSaldoPerdas write SetvalorSaldoPerdas stored valorSaldoPerdas_Specified;
    property valorSaldoResidual:      Double       Index (IS_OPTN) read FvalorSaldoResidual write SetvalorSaldoResidual stored valorSaldoResidual_Specified;
    property dataInclusao:            TXSDateTime  Index (IS_OPTN) read FdataInclusao write SetdataInclusao stored dataInclusao_Specified;
    property statusContabil:          string       Index (IS_OPTN) read FstatusContabil write SetstatusContabil stored statusContabil_Specified;
    property campanha:                Integer      Index (IS_OPTN) read Fcampanha write Setcampanha stored campanha_Specified;
    property dataStatusOperacao:      TXSDateTime  Index (IS_OPTN) read FdataStatusOperacao write SetdataStatusOperacao stored dataStatusOperacao_Specified;
    property classe:                  Integer      Index (IS_OPTN) read Fclasse write Setclasse stored classe_Specified;
    property segmento:                Integer      Index (IS_OPTN) read Fsegmento write Setsegmento stored segmento_Specified;
    property tipo:                    Integer      Index (IS_OPTN) read Ftipo write Settipo stored tipo_Specified;
    property esquemaNegociacao:       Integer      Index (IS_OPTN) read FesquemaNegociacao write SetesquemaNegociacao stored esquemaNegociacao_Specified;
    property statusSPC:               string       Index (IS_OPTN) read FstatusSPC write SetstatusSPC stored statusSPC_Specified;
    property statusHabilitado:        string       Index (IS_OPTN) read FstatusHabilitado write SetstatusHabilitado stored statusHabilitado_Specified;
    property qtdCedulas:              Integer      Index (IS_OPTN) read FqtdCedulas write SetqtdCedulas stored qtdCedulas_Specified;
    property procuradoriaResponsavel: string       Index (IS_OPTN) read FprocuradoriaResponsavel write SetprocuradoriaResponsavel stored procuradoriaResponsavel_Specified;
    property iofResponsavel:          Double       Index (IS_OPTN) read FiofResponsavel write SetiofResponsavel stored iofResponsavel_Specified;
    property qtdNegociacoes:          Integer      Index (IS_OPTN) read FqtdNegociacoes write SetqtdNegociacoes stored qtdNegociacoes_Specified;
    property valorNegociado:          Double       Index (IS_OPTN) read FvalorNegociado write SetvalorNegociado stored valorNegociado_Specified;
    property valorSaldoOperacao:      Double       Index (IS_OPTN) read FvalorSaldoOperacao write SetvalorSaldoOperacao stored valorSaldoOperacao_Specified;
    property taxaProduto:             Double       Index (IS_OPTN) read FtaxaProduto write SettaxaProduto stored taxaProduto_Specified;
    property agencia:                 string       Index (IS_OPTN) read Fagencia write Setagencia stored agencia_Specified;
    property origem:                  origem       Index (IS_OPTN) read Forigem write Setorigem stored origem_Specified;
  end;
  ...
  public
    destructor Destroy; override;
  published
    property numeroAcordo:                 Integer              Index (IS_OPTN) read FnumeroAcordo write SetnumeroAcordo stored numeroAcordo_Specified;
    property dataAcordo:                   TXSDateTime          Index (IS_OPTN) read FdataAcordo write SetdataAcordo stored dataAcordo_Specified;
    property dataAprovacao:                TXSDateTime          Index (IS_OPTN) read FdataAprovacao write SetdataAprovacao stored dataAprovacao_Specified;
    property responsavel:                  string               Index (IS_OPTN) read Fresponsavel write Setresponsavel stored responsavel_Specified;
    property responsavelAprovacao:         string               Index (IS_OPTN) read FresponsavelAprovacao write SetresponsavelAprovacao stored responsavelAprovacao_Specified;
    property situacaoAcordo:               situacaoAcordo       Index (IS_OPTN) read FsituacaoAcordo write SetsituacaoAcordo stored situacaoAcordo_Specified;
    property tipoAcordo:                   tipoAcordo           Index (IS_OPTN) read FtipoAcordo write SettipoAcordo stored tipoAcordo_Specified;
    property statusPagamento:              statusPagamento      Index (IS_OPTN) read FstatusPagamento write SetstatusPagamento stored statusPagamento_Specified;
    property statusCumprimento:            statusCumprimento    Index (IS_OPTN) read FstatusCumprimento write SetstatusCumprimento stored statusCumprimento_Specified;
    property valorNegociado:               Double               Index (IS_OPTN) read FvalorNegociado write SetvalorNegociado stored valorNegociado_Specified;
    property valorJuros:                   Double               Index (IS_OPTN) read FvalorJuros write SetvalorJuros stored valorJuros_Specified;
    property valorAjuste:                  Double               Index (IS_OPTN) read FvalorAjuste write SetvalorAjuste stored valorAjuste_Specified;
    property statusInadimplencia:          statusInadimplencia  Index (IS_OPTN) read FstatusInadimplencia write SetstatusInadimplencia stored statusInadimplencia_Specified;
    property dataInadimplencia:            TXSDateTime          Index (IS_OPTN) read FdataInadimplencia write SetdataInadimplencia stored dataInadimplencia_Specified;
    property dataUltimaModificacao:        TXSDateTime          Index (IS_OPTN) read FdataUltimaModificacao write SetdataUltimaModificacao stored dataUltimaModificacao_Specified;
    property responsavelUltimaModificacao: string               Index (IS_OPTN) read FresponsavelUltimaModificacao write SetresponsavelUltimaModificacao stored responsavelUltimaModificacao_Specified;
    property operacoes:                    operacoes            Index (IS_OPTN) read Foperacoes write Setoperacoes stored operacoes_Specified;
    property parcelas:                     parcelas             Index (IS_OPTN) read Fparcelas write Setparcelas stored parcelas_Specified;
    property escritorio:                   escritorio           Index (IS_OPTN) read Fescritorio write Setescritorio stored escritorio_Specified;
  end;
  ...
  published
    property ndg:            string         Index (IS_OPTN) read Fndg write Setndg stored ndg_Specified;
    property numero:         Integer        Index (IS_OPTN) read Fnumero write Setnumero stored numero_Specified;
    property dataVencimento: TXSDateTime    Index (IS_OPTN) read FdataVencimento write SetdataVencimento stored dataVencimento_Specified;
    property valor:          Double         Index (IS_OPTN) read Fvalor write Setvalor stored valor_Specified;
    property status:         statusParcela  Index (IS_OPTN) read Fstatus write Setstatus stored status_Specified;
    property numeroBoleto:   Integer        Index (IS_OPTN) read FnumeroBoleto write SetnumeroBoleto stored numeroBoleto_Specified;
    property dataPagamento:  TXSDateTime    Index (IS_OPTN) read FdataPagamento write SetdataPagamento stored dataPagamento_Specified;
  end;
  ...
  published
    ...
    property uf:                      uf                       Index (IS_OPTN) read Fuf write Setuf stored uf_Specified;
    property tipoEndereco:            tipoEndereco             Index (IS_OPTN) read FtipoEndereco write SettipoEndereco stored tipoEndereco_Specified;
    property enderecoCorrespondencia: enderecoCorrespondencia  Index (IS_OPTN) read FenderecoCorrespondencia write SetenderecoCorrespondencia stored enderecoCorrespondencia_Specified;
    property cliente:                 cliente                  Index (IS_OPTN) read Fcliente write Setcliente stored cliente_Specified;
  end;
  ...
  public
    destructor Destroy; override;
  published
    property ndg:               string             read Fndg write Fndg;
    property nome:              string             Index (IS_OPTN) read Fnome write Setnome stored nome_Specified;
    property tipoPessoa:        tipoPessoa         Index (IS_OPTN) read FtipoPessoa write SettipoPessoa stored tipoPessoa_Specified;
    property cpfCnpj:           string             Index (IS_OPTN) read FcpfCnpj write SetcpfCnpj stored cpfCnpj_Specified;
    property email:             string             Index (IS_OPTN) read Femail write Setemail stored email_Specified;
    property tipoNotificacao:   tipoNotificacao    Index (IS_OPTN) read FtipoNotificacao write SettipoNotificacao stored tipoNotificacao_Specified;
    property statusLocalizacao: statusLocalizacao  Index (IS_OPTN) read FstatusLocalizacao write SetstatusLocalizacao stored statusLocalizacao_Specified;
    property telefones:         telefones          Index (IS_OPTN) read Ftelefones write Settelefones stored telefones_Specified;
    property enderecos:         enderecos          Index (IS_OPTN) read Fenderecos write Setenderecos stored enderecos_Specified;
    property idOperacao:        Integer            Index (IS_OPTN) read FidOperacao write SetidOperacao stored idOperacao_Specified;
  end;
  ...
  public
    destructor Destroy; override;
  published
    property dataNascimento: TXSDateTime  Index (IS_OPTN) read FdataNascimento write SetdataNascimento stored dataNascimento_Specified;
    property operacoes:      operacoes2   Index (IS_OPTN) read Foperacoes write Setoperacoes stored operacoes_Specified;
    property acordos:        acordos      Index (IS_OPTN) read Facordos write Setacordos stored acordos_Specified;
  end;
  ...
  ['{4C58DB9D-4209-67C1-39EF-477EB0F60B4A}']
    function  pesquisarLstCliente(const parameters: pesquisarLstCliente): pesquisarLstClienteResponse; stdcall;
    function  listarClientesRetomados(const parameters: listarClientesRetomados): listarClientesRetomadosResponse; stdcall;
    function  pesquisarCliente(const parameters: pesquisarCliente): pesquisarClienteResponse; stdcall;
    function  atualizarCliente(const parameters: atualizarCliente): atualizarClienteResponse; stdcall;
  end;
...
const
  defWSDL = 'http://10.10.100.34:8680/rico-webservice/ClienteService?wsdl';
  defURL  = '';
...
destructor pesquisarClienteResponse2.Destroy;
begin
  System.SysUtils.FreeAndNil(Freturn);
  inherited Destroy;
end;

procedure pesquisarClienteResponse2.Setreturn(Index: Integer; const Acliente: cliente);
begin
  Freturn := Acliente;
  Freturn_Specified := True;
end;

function pesquisarClienteResponse2.return_Specified(Index: Integer): boolean;
begin
  Result := Freturn_Specified;
end;

destructor atualizarCliente2.Destroy;
begin
  System.SysUtils.FreeAndNil(Fcliente);
  inherited Destroy;
end;

procedure atualizarCliente2.Setcliente(Index: Integer; const Acliente: cliente);
begin
  Fcliente := Acliente;
  Fcliente_Specified := True;
end;

function atualizarCliente2.cliente_Specified(Index: Integer): boolean;
begin
  Result := Fcliente_Specified;
end;

procedure atualizarClienteResponse2.Setreturn(Index: Integer; const Astring: string);
begin
  Freturn := Astring;
  Freturn_Specified := True;
end;

function atualizarClienteResponse2.return_Specified(Index: Integer): boolean;
begin
  Result := Freturn_Specified;
end;

procedure pesquisarCliente2.Setndg(Index: Integer; const Astring: string);
begin
  Fndg := Astring;
  Fndg_Specified := True;
end;

function pesquisarCliente2.ndg_Specified(Index: Integer): boolean;
begin
  Result := Fndg_Specified;
end;

procedure pesquisarCliente2.SetcpfCnpj(Index: Integer; const Astring: string);
begin
  FcpfCnpj := Astring;
  FcpfCnpj_Specified := True;
end;

function pesquisarCliente2.cpfCnpj_Specified(Index: Integer): boolean;
begin
...
procedure pesquisarLstCliente2.Setndg(Index: Integer; const Astring: string);
begin
  Fndg := Astring;
  Fndg_Specified := True;
end;

function pesquisarLstCliente2.ndg_Specified(Index: Integer): boolean;
begin
  Result := Fndg_Specified;
end;

procedure pesquisarLstCliente2.SetcpfCnpj(Index: Integer; const Astring: string);
begin
  FcpfCnpj := Astring;
  FcpfCnpj_Specified := True;
end;

function pesquisarLstCliente2.cpfCnpj_Specified(Index: Integer): boolean;
begin
  Result := FcpfCnpj_Specified;
end;

destructor listarClientesRetomados2.Destroy;
begin
  System.SysUtils.FreeAndNil(FdataRetomada);
  inherited Destroy;
end;

procedure listarClientesRetomados2.SetdataRetomada(Index: Integer; const ATXSDateTime: TXSDateTime);
begin
  FdataRetomada := ATXSDateTime;
  FdataRetomada_Specified := True;
end;

function listarClientesRetomados2.dataRetomada_Specified(Index: Integer): boolean;
begin
  Result := FdataRetomada_Specified;
end;
...
initialization
  ...
  InvRegistry.RegisterInvokeOptions(TypeInfo(ClienteService), ioSOAP12);
  ...
  RemClassRegistry.RegisterXSClass(pesquisarClienteResponse2, 'http://service.commons.rico.ativos.com.br/', 'pesquisarClienteResponse2', 'pesquisarClienteResponse');
  RemClassRegistry.RegisterXSClass(pesquisarClienteResponse, 'http://service.commons.rico.ativos.com.br/', 'pesquisarClienteResponse');
  RemClassRegistry.RegisterXSInfo(TypeInfo(listarClientesRetomadosResponse2), 'http://service.commons.rico.ativos.com.br/', 'listarClientesRetomadosResponse2', 'listarClientesRetomadosResponse');
  RemClassRegistry.RegisterXSInfo(TypeInfo(listarClientesRetomadosResponse), 'http://service.commons.rico.ativos.com.br/', 'listarClientesRetomadosResponse');
  RemClassRegistry.RegisterXSClass(atualizarCliente2, 'http://service.commons.rico.ativos.com.br/', 'atualizarCliente2', 'atualizarCliente');
  RemClassRegistry.RegisterXSClass(atualizarCliente, 'http://service.commons.rico.ativos.com.br/', 'atualizarCliente');
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(pesquisarLstClienteResponse2), 'http://service.commons.rico.ativos.com.br/', 'pesquisarLstClienteResponse2', 'pesquisarLstClienteResponse');
  ...
  RemClassRegistry.RegisterXSClass(atualizarClienteResponse2, 'http://service.commons.rico.ativos.com.br/', 'atualizarClienteResponse2', 'atualizarClienteResponse');
  RemClassRegistry.RegisterXSClass(atualizarClienteResponse, 'http://service.commons.rico.ativos.com.br/', 'atualizarClienteResponse');
  RemClassRegistry.RegisterXSClass(pesquisarCliente2, 'http://service.commons.rico.ativos.com.br/', 'pesquisarCliente2', 'pesquisarCliente');
  RemClassRegistry.RegisterXSClass(pesquisarCliente, 'http://service.commons.rico.ativos.com.br/', 'pesquisarCliente');
  RemClassRegistry.RegisterXSClass(escritorio, 'http://service.commons.rico.ativos.com.br/', 'escritorio');
  RemClassRegistry.RegisterXSClass(pesquisarLstCliente2, 'http://service.commons.rico.ativos.com.br/', 'pesquisarLstCliente2', 'pesquisarLstCliente');
  RemClassRegistry.RegisterXSClass(pesquisarLstCliente, 'http://service.commons.rico.ativos.com.br/', 'pesquisarLstCliente');
  RemClassRegistry.RegisterXSClass(listarClientesRetomados2, 'http://service.commons.rico.ativos.com.br/', 'listarClientesRetomados2', 'listarClientesRetomados');
  RemClassRegistry.RegisterXSClass(listarClientesRetomados, 'http://service.commons.rico.ativos.com.br/', 'listarClientesRetomados');
