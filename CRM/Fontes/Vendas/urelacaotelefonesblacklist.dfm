object frmrelacaotelefonesblacklist: Tfrmrelacaotelefonesblacklist
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  Caption = 'Rela'#231#227'o Telefones Blacklist'
  ClientHeight = 701
  ClientWidth = 1370
  Color = clWhite
  ...
  object Panel1: TPanel
    ...
    object btnexportar: TRzToolButton
      AlignWithMargins = True
      Left = 1001
      Top = 3
      Width = 180
      ...
      VisualStyle = vsWinXP
      Align = alRight
      Caption = 'Remover N'#186' do Blacklist'
      Color = clRed
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -17
    ...
    object btnretornar: TRzToolButton
      ...
      VisualStyle = vsWinXP
      Align = alRight
      Caption = 'Retornar N'#186' para o Cad. Clientes'
      Color = 10053171
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -17
    ...
    object btnretirar: TRzToolButton
      AlignWithMargins = True
      Left = 815
      Top = 3
      Width = 180
      ...
      VisualStyle = vsWinXP
      Align = alRight
      Caption = 'Retirar N'#186' para o Cad. Clientes'
      Color = 1540344
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -17
  ...
  object Panel2: TPanel
    ...
    object Label3: TLabel
      ...
      Width = 145
      Height = 13
      Caption = 'Motivo de Inclus'#227'o no Blacklist'
      Visible = False
    end
    ...
    object AdvDateTimePicker1: TAdvDateTimePicker
      ...
      Ctl3D = True
      DateTime = 36526.000011574080000000
      Version = '1.3.3.0'
    ...
    object AdvDateTimePicker2: TAdvDateTimePicker
      ...
      Width = 186
      Height = 21
      Date = 43769.000000000000000000
      Format = ''
      Time = 0.470763888886722300
      DoubleBuffered = True
      Kind = dkDateTime
      ParentDoubleBuffered = False
      TabOrder = 7
      BorderStyle = bsSingle
      Ctl3D = True
      DateTime = 43769.470763888890000000
      Version = '1.3.3.0'
      LabelFont.Charset = DEFAULT_CHARSET
      LabelFont.Color = clWindowText
      LabelFont.Height = -11
  ...
  object uniscript: TFDQuery
    ...
    Left = 1272
    Top = 40
    object uniscriptCHECK_SELECAO: TBooleanField
      Alignment = taCenter
      FieldKind = fkCalculated
      FieldName = 'SEL.'
      Calculated = True
    end
    object uniscriptBANCO: TFloatField
      Alignment = taCenter
      FieldName = 'BANCO'
    end
    object uniscriptCLIENTE: TFloatField
      Alignment = taCenter
      FieldName = 'CLIENTE'
    end
    ...
    object uniscriptTELEFONE: TStringField
      Alignment = taCenter
      FieldName = 'TELEFONE'
      Size = 14
    end
    object uniscriptDATA_VALIDADE: TSQLTimeStampField
      Alignment = taCenter
      FieldName = 'DATA_VALIDADE'
    end
    object uniscriptDATA_CADASTRO: TSQLTimeStampField
      Alignment = taCenter
      FieldName = 'DATA_CADASTRO'
    end
    object uniscriptCOD_MOTIVO: TFloatField
      Alignment = taCenter
      FieldName = 'COD_MOTIVO'
    end
    object uniscriptDESC_MOTIVO: TStringField
      FieldName = 'DESC_MOTIVO'
      ReadOnly = True
      Size = 50
    end
  ...
  object uniscriptcombos: TFDQuery
    Connection = frmDataModule.UniConnection1
    Left = 1344
    Top = 40
  end
  object sSaveDialog1: TsSaveDialog
    DefaultExt = 'xls'
    FileName = 'Relac_Tel_Blacklist'
    Filter = '*.xls'
    InitialDir = 'C:\'
    Title = 'Exportar Lista para:'
    Left = 1272
    Top = 337
  end
  object AdvGridExcelIO1: TAdvGridExcelIO
    AdvStringGrid = DBAdvGrid1
    Options.ExportOverwriteMessage = 'O arquivo j'#225' existe.'
