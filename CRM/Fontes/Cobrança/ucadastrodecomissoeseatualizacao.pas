...
uses
  ucadastrodebancosempresas, ulegendacomissoes, uDataModule, uFuncoes;
...
//    unigetid.open;
    ...
    frmcadastrodebancosempresas.uniQCadastroComissoes.fieldbyname('CODIGO').Value := GetID('codigo','comissoeseatualizacao'); //unigetid.FieldByName('Sequences').Value;
