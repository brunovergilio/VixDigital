...
uses
  ...
  uPesquisaGrupoCredor, uRelImportacoes, uExtratoChamadas;
...
procedure TfrmMenu.E4Click(Sender: TObject);
begin
  Application.CreateForm(TfrmExtratoChamadas, frmExtratoChamadas);
  frmExtratoChamadas.ShowModal;
  FreeAndNil(frmExtratoChamadas);
end;
