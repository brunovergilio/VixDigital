...
uses
  ...
  FireDAC.Comp.DataSet, FireDAC.Comp.Client, FireDAC.DBX.Migrate, Vcl.Menus;
...
type
  TFrmClientes = class(TForm)
    ...
    uniQClientesListaINATIVO: TStringField;
...
procedure TFrmClientes.cxGrid1DBTableView1StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; var AStyle: TcxStyle);
begin
  if (ARecord.Values[cxGrid1DBTableView1INATIVO.Index] = 'S') then
    AStyle := cxVermelho;
end;
...
procedure TFrmClientes.JvDBGrid1DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
  if uniQClientesListaINATIVO.AsString = 'I' then
    JvDBGrid1.Canvas.Font.Color := $007575FF;
