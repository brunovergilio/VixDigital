...
uses
  ...
  uExtratoChamadas in 'uExtratoChamadas.pas' {frmExtratoChamadas};
...
begin
   ...
   Try
    ...
    fsplash.AdvProgressBar1.Position := 5;
  ...
  if frmDataModule.UniConnection1.Connected = False then
    ...
    fsplash.AdvProgressBar1.Position := 32;
    Application.ProcessMessages;

    Application.CreateForm(TfrmMenu, frmMenu);

    fsplash.lblstatus.Caption := 'Conferindo perfis de usuários...';
    fsplash.AdvProgressBar1.Position := 52;
    Application.ProcessMessages;
    ...
    fsplash.AdvProgressBar1.Position := 67;
    Application.ProcessMessages;
    ...
    fsplash.lblstatus.Caption := 'Inativando contas vencidas';
    fsplash.AdvProgressBar1.Position := 85;
    Application.ProcessMessages;

    frmMenu.uniscript.Close;
    frmMenu.uniscript.Sql.Clear;
    frmMenu.uniscript.SQL.Add('SELECT                                                 ');
    frmMenu.uniscript.SQL.Add('  o.REGISTRO,                                          ');
    frmMenu.uniscript.SQL.Add('  o.CLIENTE,                                           ');
    frmMenu.uniscript.SQL.Add('  o.DATAVENCTO,                                        ');
    frmMenu.uniscript.SQL.Add('  o.STATUS                                             ');
    frmMenu.uniscript.SQL.Add('FROM                                                   ');
    frmMenu.uniscript.SQL.Add('  operacoes o                                          ');
    frmMenu.uniscript.SQL.Add('WHERE o.DATAVENCTO BETWEEN CURDATE() - INTERVAL 120 DAY ');
    frmMenu.uniscript.SQL.Add('  AND CURDATE()                                        ');
    frmMenu.uniscript.SQL.Add('  AND o.STATUS = "S"                                   ');
    frmMenu.uniscript.SQL.Add('  AND o.INATIVO = "N"                                  ');
    frmMenu.uniscript.SQL.Add('ORDER BY o.cliente                                     ');
    frmMenu.uniscript.Open;

    while not frmMenu.uniscript.Eof do
    begin
      frmMenu.FDQuery1.Close;
      frmMenu.FDQuery1.SQL.Clear;
      frmMenu.FDQuery1.SQL.Add('UPDATE                     ');
      frmMenu.FDQuery1.SQL.Add('  operacoes                ');
      frmMenu.FDQuery1.SQL.Add('SET                        ');
      frmMenu.FDQuery1.SQL.Add('  inativo = "S"            ');
      frmMenu.FDQuery1.SQL.Add('WHERE REGISTRO = :Registro ');
      frmMenu.FDQuery1.ParamByName('Registro').AsInteger := frmMenu.uniscript.FieldByName('registro').AsInteger;
      frmMenu.FDQuery1.ExecSQL;

      frmMenu.FDQuery1.Close;
      frmMenu.FDQuery1.SQL.Clear;
      frmMenu.FDQuery1.SQL.Add('UPDATE                ');
      frmMenu.FDQuery1.SQL.Add('  clientes            ');
      frmMenu.FDQuery1.SQL.Add('SET                   ');
      frmMenu.FDQuery1.SQL.Add('  inativo = "S"       ');
      frmMenu.FDQuery1.SQL.Add('WHERE CPF_CNPJ = :CPF ');
      frmMenu.FDQuery1.ParamByName('CPF').AsString := frmMenu.uniscript.FieldByName('CLIENTE').AsString;
      frmMenu.FDQuery1.ExecSQL;
      frmMenu.uniscript.Next;
    end;
