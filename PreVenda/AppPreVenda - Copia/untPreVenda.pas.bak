...
uses
  ...
  ppParameter, ppCtrls, dxGDIPlusClasses, ppPrnabl, ppDB, ppDBPipe,
  IBCustomDataSet, IBQuery, ppStrtch, ppMemo, MidasLib, cxGraphics,
...
implementation
Uses
  untUtil, untDMPrincipal, untDmPreVenda, uFrmConsultaCliente, uFrmConsultaCFOP,
  uFrmConsultaVendedor, uFrmConsultatransportadora, uFrmConsultaProdutos,
  uFrmConsultarVendasEmitidas, untFrmTipoVenda;
...
begin
  ...
  try
    ...
    edtQtdeLinhas.Text:= untUtil.CompletarZerosEsquerda(dmPreVenda.RetornaQtdeLinhas, 4);
