...
uses
  SysUtils, Classes, DB, IBCustomDataSet, IBQuery, DBClient, Forms, StrUtils,
  dxmdaset;
...
implementation
Uses untDMPrincipal, untUtil, untPreVenda;
...
begin
  ...
  QryAux.Open;
  Result := untUtil.CompletarZerosEsquerda(QryAux.Fields[0].AsInteger,10);
end;
...
begin
  ...
  Result := untUtil.CompletarZerosEsquerda(vProx,10);
end;
