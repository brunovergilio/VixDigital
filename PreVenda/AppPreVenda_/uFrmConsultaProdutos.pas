...
implementation
Uses uDmPesquisaProdutos, untUtil, untDmPreVenda, untPreVenda;
...
begin
  ...
  FrmPreVenda.edtQtdeLinhas.Text:= untUtil.CompletarZerosEsquerda(dmPreVenda.RetornaQtdeLinhas, 4);
