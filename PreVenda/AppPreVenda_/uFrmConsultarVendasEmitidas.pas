unit uFrmConsultarVendasEmitidas;
...
uses
  ...
  cxTextEdit, cxMaskEdit, cxDropDownEdit, cxCalendar, Vcl.StdCtrls, cxStyles,
  dxSkinscxPCPainter, cxCustomData, cxFilter, cxData, cxDataStorage,
  cxNavigator, Data.DB, cxDBData, cxGridLevel, cxClasses, cxGridCustomView,
  cxGridCustomTableView, cxGridTableView, cxGridDBTableView, cxGrid, Vcl.Menus,
  cxButtons, IBCustomDataSet, IBQuery, cxCurrencyEdit, ACBrBoleto,
  ACBrBoletoFCFR, ACBrBase, AcbrUtil, cxButtonEdit;
...
implementation
uses untDMPrincipal, untPreVenda, uFrmOpcoesBoleto, untUtil;
